...
@if(is_default_lang())
    <div class="row " data-condition="sms_driver:is(msgbucket)">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__('Config MsgBucket Driver')}}</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(msgbucket)">
                        <div class="form-group">
                            <label class="">{{__("MsgBucket Api Token")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_msgbucket_api_key" value="{{setting_item('sms_msgbucket_api_key',config('sms.msgbucket.key')) }}">
                            </div><br>
                            <label class="">{{__("Get yours today for FREE !!")}}</label>                          
                            <a href="https://wa.msgbucket.com" target="_blank" >Click here</a>
